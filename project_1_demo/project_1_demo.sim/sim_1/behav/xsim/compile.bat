...
REM
REM Generated by Vivado on Mon Nov 21 07:46:41 +0530 2022
...
echo "xvlog --incr --relax -prj tb_simulation_vlog.prj"
call xvlog  --incr --relax -prj tb_simulation_vlog.prj -log xvlog.log
