...
REM
REM Generated by Vivado on Mon Nov 21 07:46:46 +0530 2022
...
call xsim  tb_simulation_behav -key {Behavioral:sim_1:Functional:tb_simulation} -tclbatch tb_simulation.tcl -log simulate.log
